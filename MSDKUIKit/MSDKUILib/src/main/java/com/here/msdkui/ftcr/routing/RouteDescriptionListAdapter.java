...
public class RouteDescriptionListAdapter extends RecyclerView.Adapter<RouteDescriptionListAdapter.ViewHolder> {
    ...
    private final List<FTCRRoute> mRouteList;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final FTCRRoute route = mRouteList.get(position);
        if (route != null && holder.itemView instanceof RouteDescriptionItem) {
            ...
            ((RouteDescriptionItem) holder.itemView).setRoute(route, mRoutePlan);
        }
    }
     ...
     */
    void updateScaling() {
        mRouteBarScaler.scaleRoutes(mRoutePlan.getRouteOptions(), mRouteList);
    }
    ...
    public void setRoutePlan(FTCRRoutePlan routePlan) {
        mRoutePlan = routePlan;
    }
