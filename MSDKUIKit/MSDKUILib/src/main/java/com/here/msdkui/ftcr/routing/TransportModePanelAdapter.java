...
public abstract class TransportModePanelAdapter extends FragmentStatePagerAdapter {
    ...
    private List<FTCRRouteOptions.TransportMode> mTransportModes;
     ...
     */
    public TransportModePanelAdapter(final FragmentManager manager, final List<FTCRRouteOptions.TransportMode> transportModes) {
        super(manager);
     ...
     */
    public List<FTCRRouteOptions.TransportMode> getTransportModes() {
     ...
     */
    public void setTransportModes(final List<FTCRRouteOptions.TransportMode> transportModes) {
        mTransportModes = transportModes;
    }
