...
public class GuidanceManeuverView extends BaseView {
     ...
     * @see #setViewState(GuidanceManeuverView.State)
     * @deprecated This method will be removed. Please see {@link #getViewState()}.
     */
    ...
    /**
     * Gets the {@link GuidanceManeuverView.State GuidanceManeuverView.State} of this view which was used for
     * UI population.
     *
    ...
    /**
     * Sets the {@link GuidanceManeuverView.State GuidanceManeuverView.State} which will be used for UI population.
     ...
     *
     * @param state the {@link GuidanceManeuverView.State GuidanceManeuverView.State} to populate the UI.
    ...
    public static class State implements Parcelable {
         ...
         *
         * @param data {@link GuidanceManeuverData} to populate the view.
         */
        ...
        /**
         * Gets the {@link GuidanceManeuverData} state used to populate the view.
         *
         * @return data {@link GuidanceManeuverData}.
         */
