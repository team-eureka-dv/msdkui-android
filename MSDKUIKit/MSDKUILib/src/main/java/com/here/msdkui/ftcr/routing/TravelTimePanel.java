...
public final class TravelTimePanel extends RelativeLayout implements TravelTimePicker.OnTimePickedListener {
    ...
    private void displayTimeTypeOnUi() {
        ...
        if (mTimeType == FTCRRouteOptions.TimeType.ARRIVAL) {
    ...
    @Override
    public void onTimePicked(final Date date, final FTCRRouteOptions.TimeType type) {
        setTime(date);
        setTimeType(type);
    }
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(Date date, FTCRRouteOptions.TimeType type);
    }
}
