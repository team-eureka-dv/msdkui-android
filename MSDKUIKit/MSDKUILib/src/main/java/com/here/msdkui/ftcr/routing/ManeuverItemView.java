...
public class ManeuverItemView extends BaseView {
    ...
    private FTCRManeuver mManeuver;
     ...
     */
    public FTCRManeuver getManeuver() {
        return mManeuver;
    }
     ...
     */
    public void setManeuver(final List<FTCRManeuver> maneuvers, final int pos) {
        if (maneuvers == null) {
        ...
        final int distance = maneuverResources.getDistanceFromNext(maneuvers, pos);
        if (distance == 0) {
