...
public class GuidanceSpeedLimitView extends BaseView {
     ...
     */
    public @NonNull
    GuidanceSpeedData getCurrentSpeedData() {
    ...
    static class SavedState extends BaseSavedState {
         ...
         */
        public static final Creator<GuidanceSpeedLimitView.SavedState> CREATOR =
                new Creator<GuidanceSpeedLimitView.SavedState>() {
