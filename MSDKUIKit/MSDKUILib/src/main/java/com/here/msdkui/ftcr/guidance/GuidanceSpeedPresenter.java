...
public class GuidanceSpeedPresenter extends BaseGuidancePresenter {
     ...
     */
    public GuidanceSpeedPresenter(@NonNull FTCRNavigationManager navigationManager,
            @NonNull PositioningManager positioningManager) {
        super(navigationManager, positioningManager, null);
